    ...
    functionDeclarations: [
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            tipo: { type: "STRING", enum: ["landing", "multipage", "ecommerce"], description: "Tipo de sitio web a generar" },
            colores: {
              type: "OBJECT",
              properties: {
...
1. Debes recolectar 4 datos clave: Nombre del negocio, Tipo de sitio (landing, multipage o ecommerce), Color primario (hexadecimal) y una breve Descripción.
2. Sé creativo y sugiere colores si el usuario no está seguro.
3. IMPORTANTE: Una vez que tengas TODOS los datos confirmados, DEBES responder incluyendo un bloque JSON con esta estructura exacta (puedes agregar un mensaje antes del JSON):
{
  "generar_sitio": true,
...
4. NO generes el JSON hasta tener los datos confirmados por el usuario.
` : '';
